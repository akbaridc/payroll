...
const Employee = ({ methods }: { methods: any }) => {
  return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <ComboboxForm className="custom-field" form={methods} name="employee.divisi" label="Divisi" combobox={[]} />
        <ComboboxForm className="custom-field" form={methods} name="employee.level" label="Level" combobox={[]} />
