    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ComboboxForm
                ...
                form={methods}
                name="payroll.category_employee"
                label="Category Employee"
                combobox={StatusEmployees()}
            />
            <FormInputField
                className="custom-field w-full"
                form={methods}
                name="payroll.salary"
                label="Basic Salary / Hours"
            />
            <FormInputField
                className="custom-field w-full"
                form={methods}
            ...
            <FormInputField
                className="custom-field w-full"
                form={methods}
                name="payroll.acc_number"
                label="Account Number"
            />
            <FormInputField
                className="custom-field w-full"
                form={methods}
                name="payroll.acc_name"
                label="Account Name"
            />
            <FormInputField
                className="custom-field w-full"
            ...
            <ComboboxForm
                className="custom-field"
                form={methods}
                name="payroll.obligation"
                label="Status Obligation"
                combobox={[]}
            />
        </div>
    );
