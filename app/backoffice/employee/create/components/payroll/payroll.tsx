...
const Payroll = ({ methods }: { methods: any }) => {
  ...
  return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ComboboxForm className="custom-field" form={methods} name="payroll.category_employee" label="Category Employee" combobox={religionOption} />
          ...
          <ComboboxForm className="custom-field" form={methods} name="payroll.bank" label="Bank" combobox={religionOption} />
          ...
          <ComboboxForm className="custom-field" form={methods} name="payroll.ptpk" label="Category PTKP" combobox={religionOption} />
          ...
          <ComboboxForm className="custom-field" form={methods} name="payroll.tax" label="Tax Method" combobox={religionOption} />
          <ComboboxForm className="custom-field" form={methods} name="payroll.type_tax" label="Type of Tax" combobox={religionOption} />
          <ComboboxForm className="custom-field" form={methods} name="payroll.obligation" label="Status Obligation" combobox={religionOption} />
      </div>
    );
  };
