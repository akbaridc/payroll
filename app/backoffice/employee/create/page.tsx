    ...
    const steps = [
        {
            ...
            title: "Personal",
            form: "personal",
            content: <Personal methods={methods} />,
        },
        {
            id: 2,
            title: "Employee",
            form: "employee",
            content: <Employee methods={methods} />,
        },
        {
            id: 3,
            title: "Payroll",
            form: "payroll",
            content: <Payroll methods={methods} />,
        },
        {
            id: 4,
            title: "Family",
            form: "family",
            content: <Family methods={methods} />,
        },
        {
            id: 5,
            title: "Employee Residence",
            form: "residence",
            content: <Residence methods={methods} />,
        },
