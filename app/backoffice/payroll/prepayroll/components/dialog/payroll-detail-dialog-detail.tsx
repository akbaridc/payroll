                                            ...
                                            {dataTabelPayrollDetail && (
                                                dataTabelPayrollDetail.map((item, index) => (
                                                    <tr key={item.trans_payroll_detail2_id}>
                                                        ...
                                                        <td className="px-4 py-2">
                                                            <FormInputField className="w-full p-2 border border-gray-300 rounded" name="trans_payroll_detail2_value" value={formatCurrency(item.trans_payroll_detail2_value)} label="" data-id={item.trans_payroll_detail2_id} onChange={handleInputChange} onInput={setFormatCurrency} disabled />
                                                        </td>
                                                        <td className="px-4 py-2">
